...
* "Poor" handwriting, such as image 2753, is an issue we may need to address in our classification algorithm.
...
```
This is interesting because we can see that despite the different styles and quality of handwriting, the pixels for each digit are generally in the same area. This also means there are some pixels that are never used or used very little
